    ...
    public partial class Register : Form
    {
        ...
        private void signup_btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Usernametxt.Text == "" || Passwordtxt.Text == "" || phone_txt.Text == "" || email_txt.Text == "" || adr_txt.Text == "" || typ_txt.Text == "")
                {
                ...
                string insert_qr = "insert into Users (Username, password,Email,phone,address,type) values('" + Usernametxt.Text + "','" + Passwordtxt.Text + "','" + email_txt.Text + "','" + phone_txt.Text + "','" + adr_txt.Text + "','" + typ_txt.Text + "')";
